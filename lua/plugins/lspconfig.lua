	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				-- See .config/nvim/lua/plugins/editor-conform.lua
			end,
		})
		...
		-- Workaround for Neovim 0.11.5 dynamic registration bug
		-- Ensure dynamic registration fields are initialized as tables
